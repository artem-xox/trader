...
2. Evaluate candidates on: relevance to the topic, the implied probability vs. your own
   read of how likely the outcome is (the edge), liquidity/volume, and time horizon.
3. Return a short ranked shortlist (up to 5) of the most interesting markets.
